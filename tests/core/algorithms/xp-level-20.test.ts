...
describe('XP Level 20 Support', () => {
  test('should return correct XP for all levels 1-20', () => {
  ...
  test('should clamp getXpForLevel below 1', () => {
    expect(getXpForLevel(0)).toBe(0);
    expect(getXpForLevel(-1)).toBe(0);
  });

  test('should clamp getXpForLevel above 20', () => {
    expect(getXpForLevel(21)).toBe(92800); // Level 20 XP
    expect(getXpForLevel(100)).toBe(92800);
  });

  test('should calculate correct level from XP for all levels', () => {
  ...
  test('should be monotonic: higher XP always gives higher or equal level', () => {
